...
-- pagamentos (multiplos por cliente)
insert into payments (idClient, idPayment, typePayment, limitAvailable)
values (1,1,'Cartão',2000),
       (1,2,'Boleto',NULL),
       (2,1,'Dois cartões',5000);
...
-- Entregas
insert into delivery (idOrder, statusDelivery, trackingCode)
values (1,'Em transporte','TRK12345'),
       (2,'Entregue','TRK67890'),
       (3,'Cancelado','TRK11111'),
       (4,'Em transporte','TRK22222');
...
values ('Almeida e filhos', 123456789123451,'21985474'),
	   ('Eletrônicos Silva',814519649143457,'21985484'),
	   ('Eletrônicos Valma', 934565893934695,'21975474');
